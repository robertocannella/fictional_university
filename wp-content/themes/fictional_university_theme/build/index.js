...
class Search {
  ...
  async getResults() {
    ...
    if (!res.data[0]) {
      ...
      let results = '';
      res.data.map(item => // results += "<li> <a href=\"" + item.link + "\">" + item.title.rendered +  "</li>"
  ...
  keyPressDispatcher(e) {
    if (!document.activeElement) this.openOverlay(); // if (e.keyCode == 83 && !this.isOverlayOpen && !document.getElementsByClassName("input, textarea").is(":focus")) {
    //     this.openOverlay()
    // }
