...
class Search {
  ...
  constructor() {
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "typingTimer", void 0);
    ...
    this.previousValue = ''; //this.typingTimer
  ...
  async getResults() {
    ...
    const asyncResults = Promise.all([axios__WEBPACK_IMPORTED_MODULE_1___default().get(`${globalSiteData.siteUrl}/wp-json/wp/v2/posts`, {
      params: {
        search: this.searchField.value
      }
    }), axios__WEBPACK_IMPORTED_MODULE_1___default().get(`${globalSiteData.siteUrl}/wp-json/wp/v2/pages`, {
      params: {
        search: this.searchField.value
      }
    })]);
    ...
    try {
      ...
      if (!combinedResults.length) {
        ...
        let results = '';
        combinedResults.map(item => // results += "<li> <a href=\"" + item.link + "\">" + item.title.rendered +  "</li>"
  ...
  keyPressDispatcher(e) {
    if (e.keyCode == 83 && !this.isOverlayOpen && !document.querySelector(":focus")) this.openOverlay();
