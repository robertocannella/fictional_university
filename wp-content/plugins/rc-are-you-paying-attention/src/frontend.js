...
function Quiz (props) {
    ...
    return (
        ...
        <div className="paying-attention-frontend" style={{backgroundColor: props.bgColor ? props.bgColor : '#ebebeb', textAlign: props.theAlignment}}>
                ...
                {props.answers.map((answer)=>{
                    return (
                        <li
                            ...
                            onClick={isCorrect == true ? undefined : () => onGuess(answer.id) }>
                            {isCorrectDelayed && answer.id == props.correctAnswer && (
